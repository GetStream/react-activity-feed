...
<div style={{ backgroundColor: '#F0F0F0', padding: 20 }}>
  ...
  <Panel panelStyle="square">
    <PanelHeading closeButton={false}>
      ...
      >
        <path d="M19 4l-4-4v3H0v2h15v3z" fill="#02D4B1" fillRule="evenodd" />
      </svg>
      <Avatar rounded size={30} />
      <p style={{ fontSize: 12 }}>
      ...
      <Panel panelStyle="square">
        <PanelContent>
          ...
          <p>
            Hi Cindy,
            <br />
            <br />I hope I'm not bothering you. Could you please refer me to the
            person in charge of [something that's relevant to my product]?
            <br />
            <br />
