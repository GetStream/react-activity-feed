...
import { FeedContext, FeedCtx } from '../Context';
import { Renderable, BaseFeedCtx } from '../types';
  ...
  render() {
    return (
      <FeedContext.Consumer>
        {// TODO this appears to be a feed context, is `appCtx` a misnomer?
        (appCtx: FeedCtx) => <ReactionListInner {...this.props} {...appCtx} />}
      </FeedContext.Consumer>
    );
  }
}
