...
export const TranslationProviderMock = ({ value = translationProviderData, children }: TranslationProviderMockProps) => (
  <TranslationProvider value={value}>{children}</TranslationProvider>
);
