...
export type TDateTimeParser<T extends Dayjs.Dayjs | Moment = Dayjs.Dayjs> = (
  input?: string | Date | (T extends Dayjs.Dayjs ? Dayjs.Dayjs : Moment),
) => T extends Dayjs.Dayjs ? Dayjs.Dayjs : Moment;
